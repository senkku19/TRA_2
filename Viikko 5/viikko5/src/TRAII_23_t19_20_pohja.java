...
public class TRAII_23_t19_20_pohja {
    ...
    static void onYhtenainen(Graph G) {
    ...
    static void taydenna2yhtenaiseksi(Graph G) {
        ...
        // TODO
        //Haetaan kaikki leikkaussolmut
        LinkedList<Vertex> leikkausSolmut = leikkausSolmut(G);
        //Luodaan muuttuja
        Vertex edellinen = null;
        //Käydään läpi leikkaussolmut
        for(Vertex v : leikkausSolmut) {
            //Ja leikkaus solmun naapurit
            for(Vertex w : v.neighbors()) {
                //Jos apusolmu edellinen ei ole tyhjä
                if (edellinen != null) {
                    //Eikä tutkittavan naapurin ja edellisen välillä ole kaarta
                    if (w.getEdge(edellinen) == null) {
                        //Lisätään kaari solmujen väliin
                        w.addEdge(edellinen);
                    }
                }
                //Päivitetään muuttujaa
                edellinen = w;
            }
        }
